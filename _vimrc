...
" $VimStateSavedFiles为Windows系统中定义的环境变量，
" $VimStateSavedFiles=D:\Program Files (x86)\Vim\vimfiles\StateSavedFiles
let s:sessionfile=$VimStateSavedFiles . '/session.vim'
